...
WITH insert_message AS (
  INSERT INTO message (user_id, subject, body, status, location, failure_reason) 
  VALUES (8, 'Schnitzel Recipe Idea', 'I’m thinking of trying out a schnitzel recipe with a twist this weekend. Instead of the classic breadcrumbs, I want to experiment with panko and add some parmesan cheese to give it a cheesy crunch. Also, I’m going to serve it with a homemade lemon butter sauce for an extra layer of flavor. Anyone tried something like this before? I’m hoping it turns out as delicious as I’m imagining!', 'draft', 'draft', NULL) 
  RETURNING id
)
INSERT INTO recipient (message_id, phone)
SELECT 
...
WITH insert_message AS (
  INSERT INTO message (user_id, subject, body, status, location, failure_reason) 
  VALUES (8, 'Floki Inu – What Happened?!', 'I tried to get into Floki Inu earlier this year, but things aren’t looking great right now. My investment is sinking fast, and it’s been really frustrating to watch the market crash. I was hoping the hype would drive up the price, but it seems like I was wrong. Should I cut my losses now, or hold on a bit longer? Let me know if you’ve had better luck with Floki or other meme coins!', 'failed', 'trash', 'Market crash') 
  RETURNING id
)
INSERT INTO recipient (message_id, phone)
SELECT 
...
WITH insert_message AS (
  INSERT INTO message (user_id, subject, body, status, location, failure_reason) 
  VALUES (8, 'Schnitzel with a Twist!', 'I’m planning to make schnitzel this weekend, but I want to try something different. I’m thinking of using sweet potato fries as a side instead of the usual potatoes. I love how crispy and sweet they get in the oven! Also, I’m going to try a new schnitzel coating with panko and Parmesan. It sounds like a game-changer! What do you think, should I go for it or stick with the classic recipe?', 'scheduled', 'draft', NULL) 
  RETURNING id
)
INSERT INTO recipient (message_id, phone)
SELECT 
...
WITH insert_message AS (
  INSERT INTO message (user_id, subject, body, status, location, failure_reason) 
  VALUES (8, 'DogeCoin Still Going Strong!', 'Is anyone still holding DogeCoin? I know it started as a joke, but it’s doing way better than I expected. The community around Doge is so strong, and it’s got serious potential for growth. I’ve been holding mine for a while, and I’ve made some decent profits. If you’re thinking about getting in, now might be a good time, especially if you can get it at a good price. Let’s ride this wave together!', 'sent', 'sent', NULL) 
  RETURNING id
)
INSERT INTO recipient (message_id, phone)
SELECT 
...
WITH insert_message AS (
  INSERT INTO message (user_id, subject, body, status, location, failure_reason) 
  VALUES (8, 'Bavarian Pretzels at Home!', 'I tried making homemade Bavarian pretzels for the first time yesterday, and they actually turned out pretty good! The dough was soft and chewy, just like the ones you get in beer gardens in Germany. I made sure to follow the instructions carefully, and it worked out perfectly. The best part is the crispy, salty crust on top. If you’re looking for a fun project to do, I definitely recommend giving pretzels a go!', 'sent', 'sent', NULL) 
  RETURNING id
)
INSERT INTO recipient (message_id, phone)
SELECT 
