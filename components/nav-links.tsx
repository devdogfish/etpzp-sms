...
export default function NavLinks({ links, isCollapsed, isMobileList }: NavProps) {
  ...
  return (
    <div
      ...
      className={cn(`group flex flex-col gap-4 py-2 data-[collapsed=true]:py-2`, isMobileList && "w-[250px]")}
    >
